...
public class ActivityGrabar extends AppCompatActivity {
    VideoView videoview;
    Button btnVer, btnguardar;
    String curpath;
    byte[] Arrayvideo;
    ...
    public void otorgarpermisos( VideoView videoview) {
    ...
    private void guardarvideo() {
        SQLiteConexion conexion = new SQLiteConexion(this, Transacciones.NameDatabase2,null,1);
    ...
    private void VideoIntent() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            try {
                ...
                AlertDialog.Builder adb = new AlertDialog.Builder(ActivityGrabar.this);
                adb.setTitle("EXITO");
